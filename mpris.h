...
class MprisControlPlugin : QObject {
    Q_OBJECT

public:
    explicit MprisControlPlugin(QObject *parent);
    ...
    std::vector<GlobalSystemMediaTransportControlsSession::MediaPropertiesChanged_revoker>
    mediaPropertiesChangedHandlers;
    std::vector<GlobalSystemMediaTransportControlsSession::TimelinePropertiesChanged_revoker>
    ...
    void sendMediaProperties(const QString &name, const GlobalSystemMediaTransportControlsSession &player);

    void sendPlaybackInfo(const QString &name, const GlobalSystemMediaTransportControlsSession &player);

    void sendTimelineProperties(const QString &packetOrName,
